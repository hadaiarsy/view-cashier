                        ...
                        @foreach ($member as $m)
                            ...
                            @if ($loop->last)
                                <tr>
                                    ...
                                    <td style="text-align: right">{{ $helper->money_format($tsaldoawalunit) }}</td>
                                    <td style="text-align: right">{{ $helper->money_format($tpenambahanunit) }}</td>
                                    <td style="text-align: right">{{ $helper->money_format($tpembayaranunit) }}</td>
                                    <td style="text-align: right">{{ $helper->money_format($tsaldoakhirunit) }}</td>
                                </tr>
                            @endif
                        @endforeach
                    @endforeach
